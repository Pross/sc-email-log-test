...
class LogListPage extends BasePage {
	...
	public function load_view_logs_assets( $hook ) {
		...
		wp_enqueue_style( 'jquery-ui-css', $plugin_dir_url . 'assets/css/admin/jquery-ui.min.css', array(), $email_log->get_version() );
		...
		wp_enqueue_script( 'el-view-logs', $plugin_dir_url . 'assets/js/admin/view-logs.js', array( 'jquery-ui-datepicker', 'insertionQ', 'jquery-ui-tooltip' ), $email_log->get_version(), true );
	}
}
